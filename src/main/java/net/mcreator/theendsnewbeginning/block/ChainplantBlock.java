...
public class ChainplantBlock extends NewendModElements.ModElement {
	@ObjectHolder("newend:chainplant")
	public static final Block block = null;

	public ChainplantBlock(NewendModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chainplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("newend:chainplant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			...
			return ground == this || (ground == ChainplantEdgeBlock.block
